# reads a time series for a given location and plots both the RCP 8.5 and 4.5 scenarios for all ensembles for monthly data
...
boxplot(formula = RCP45 ~ decade,
        ...
        ylim    = c(min( c(var1d$RCP45, var1d$RCP85) ),
                    max( c(var1d$RCP45, var1d$RCP85) )
                    ),
