...
year_start      = 1980              # start year
year_end        = year_start + 30-1 # end year
...
For maximium storm events 

1) Loop through each ensemble, each time collecting the return amounts for a 1-, 2-, 5-, 10-, 15-, 20-yr event

2) compile them to get the average 1-, 2-, 5-, 10-, 15-, 20- return period and the variance of each.
